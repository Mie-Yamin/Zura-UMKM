...
| **Ammar Daffa Ilyasa** | UI/UX Designer | [@username](https://github.com/username) |
...
### Live Demo
🔗 **[Kunjungi Website ZURA](https://[URL_DEMO])**
...
### Video Demo
📹 **[Link Video Demo Proyek](https://[URL_VIDEO])**
...
Bash
git clone [https://github.com/username/zura.git](https://github.com/username/zura.git)
cd zura
...
Firestore Endpoints & Collections
HTTP
