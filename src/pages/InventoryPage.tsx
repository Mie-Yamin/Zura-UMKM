...
export default function InventoryPage() {
  ...
  return (
    <div className="min-h-screen bg-[#E8D3A7] text-[#0F172A] p-6 flex flex-col gap-6 font-dmsans" aria-label="Manajemen Stok Pusat">
      ...
      <header className="flex flex-col md:flex-row items-center justify-between gap-4 bg-white p-5 rounded-2xl border border-transparent shadow-sm">
        ...
        <div className="flex items-center gap-3 w-full md:w-auto justify-end">
          <span className="bg-[#5F1E1E] text-[#E8D3A7] text-xs font-bold px-3.5 py-2 rounded-xl uppercase tracking-wider shadow-sm">
      ...
      {/* ─── FILTER & SEARCH BAR ─── */}
      <section className="bg-white p-4 rounded-2xl shadow-sm flex flex-col md:flex-row gap-4 items-center justify-between">
        ...
        <div className="relative w-full md:w-80">
          <input
            ...
            className="w-full bg-[#E8D3A7]/20 border-2 border-[#B48328] text-[#5F1E1E] rounded-xl pl-9 pr-4 py-2 text-xs font-bold focus:outline-none placeholder-[#B48328]/70"
          />
        ...
        <div className="flex items-center gap-3 w-full md:w-auto flex-wrap justify-end">
          ...
          <div className="relative">
            <select
              ...
              className="appearance-none bg-white border-2 border-[#B48328] text-[#5F1E1E] rounded-xl pl-3 pr-8 py-2 text-xs font-bold tracking-wider uppercase focus:outline-none cursor-pointer"
            >
              {categories.map((cat) => (
      ...
      <section className="bg-white rounded-2xl shadow-sm border border-transparent overflow-hidden">
        {isLoading ? (
