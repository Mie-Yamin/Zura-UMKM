...
export default function MenuPage() {
    ...
    const menuGridItems = [
        { title: 'DASHBOARD', image: '/dashboard.png', path: '/dashboard' },
        { title: 'REKAP PENJUALAN', image: '/rekapPenjualan.png', path: '/rekap' },
        { title: 'MANAJEMEN STOK', image: '/manajemenStok.png', path: '/inventory' },
        { title: 'LAPORAN KEUANGAN', image: '/laporanKeuangan.png', path: '/finance' },
        { title: 'CRM', image: '/crm.png', path: '/customers' },
        { title: 'AI Insight Hub', image: '/aiInsight.png', path: '/ai-insights' },
    ];
        ...
        <div className="fixed inset-0 w-screen h-screen bg-[#5F1E1E] text-white font-sans overflow-hidden flex flex-col justify-between select-none">
            ...
            <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-4 py-3 md:py-4 md:px-12 bg-gradient-to-b from-[#5F1E1E]/90 to-transparent backdrop-blur-[2px]">
                ...
                <div className="hidden md:flex space-x-6 lg:space-x-8 text-sm font-medium items-center">
                    ...
                    <button
                        className="border-2 md:border-[3px] border-[#E8D3A7] text-[#E8D3A7] py-1 px-5 md:py-1.5 md:px-6 rounded-full transition-all duration-300 bg-transparent font-medium"
                    >
                        Menu
                    </button>
                </div>
            ...
            {mobileMenuOpen && (
                <div className="fixed inset-0 z-40 md:hidden">
                    ...
                    <div className="absolute top-14 right-3 w-44 rounded-xl shadow-2xl p-3 space-y-1 bg-[#5F1E1E] border border-[#E8D3A7]/30">
                        ...
                        <button
                            className="w-full text-left text-sm px-3 py-2 rounded-lg border border-[#E8D3A7] text-[#E8D3A7] font-semibold transition-all"
                        >
                            Menu
                        </button>
                    </div>
