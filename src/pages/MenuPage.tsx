...
export default function MenuPage() {
    ...
    const menuGridItems = [
        {
            title: "DASHBOARD",
            image: "/landingPage/dashboard.svg",
            path: "/dashboard"
        },
        {
            title: "REKAP PENJUALAN",
            image: "/landingPage/rekapPenjualan.svg",
            path: "/rekap"
        },
        {
            title: "MANAJEMEN STOK",
            image: "/landingPage/manajemenStok.svg",
            path: "/inventory",
        },
        {
            title: "LAPORAN KEUANGAN",
            image: "/landingPage/laporanKeuangan.svg",
            path: "/finance",
        },
        {
            title: "CRM",
            image: "/landingPage/crm.svg",
            path: "/customers"
        },
        {
            title: "AI Insight Hub",
            image: "/landingPage/aiInsight.svg",
            path: "/ai-insights"
        },
    ];
